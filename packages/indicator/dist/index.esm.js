...
function normalizeComponent(e, t, n, i, o, a, r, s, d, l) {
  typeof r === 'function' && ((d = s), (s = r), (r = !1))
  var c

  var _ = typeof n === 'function' ? n.options : n
  if (
    (e &&
      e.render &&
      ((_.render = e.render),
...
function addStyle(e, t) {
  ...
  if (!i.ids.has(e)) {
    ...
    if (
      ...
      s[a] && i.element.removeChild(s[a]),
        s.length ? i.element.insertBefore(r, s[a]) : i.element.appendChild(r)
    }
  }
}
