<template>
  <div class="popup">
    <div class="popup-btn popup-center" @click="showPopup('center')">center</div>
    <div class="popup-btn popup-center" @click="showPopup('top')">top</div>
    ...
    <popup v-model="show" class="popup-wrap" :position="pos">
      <p>I am {{ pos }} popup</p>
    </popup>
  </div>
</template>
